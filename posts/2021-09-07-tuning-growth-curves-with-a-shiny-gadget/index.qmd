...
Unfortunately, while we have improved the growth curve by changing `gamma`, we have
...
We have also messed up the biomasses of some of the species,
...
```{r echo=FALSE, column="page", preview=TRUE}

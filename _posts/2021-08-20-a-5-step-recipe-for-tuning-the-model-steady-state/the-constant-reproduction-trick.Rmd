...
```{r}
remotes::install_github("mizerExperimental")
...
cutoff <- species_params$w_mat / 20
bm_hist <- getBiomass(NS_sim, min_w = cutoff)[years, ]
species_params$biomass_observed <-  colSums(bm_hist) / 21
species_params$biomass_cutoff <- cutoff

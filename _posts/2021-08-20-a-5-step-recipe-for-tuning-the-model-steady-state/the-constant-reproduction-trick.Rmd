...
species are and how they are fished. 

2. Create a mizer model that in its steady state  reproduces the time-averaged
observed state of our fish community. Of course your real system never is in a
...
3. Once we have obtained a model whose steady state agrees with average
observations, you should tune the model parameters further to also

...
By calculating the numbers at age, as done in the previous section, we can calculate how many individuals die in a cohort in a year. Consider that at time $t-1$ and $t$ we have calculated numbers age $a-1$ and $a$ respectively, then we can rearrange equation \@ref(eq:grow) to find
\begin{equation}
